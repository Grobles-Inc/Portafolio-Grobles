  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div className="flex flex-col items-center text-center space-y-6 py-12"
        data-aos="fade-up"
      >
        <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold">Somos Grobles Startup Líder en <span className="text-yellow-300 italic">Desarrollo de Software</span></h1>
